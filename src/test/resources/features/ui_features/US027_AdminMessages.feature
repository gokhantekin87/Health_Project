 ...
 Feature: Messages by Admin Validate with API and DB
   ...
   Background:
     ...
     And Admin SignIn'e tıklar



   @US027_TC01 @Smoke
     Scenario Outline: Admin, mesaj portalına gidebilir ve tüm mesajları, yazarlarını ve e-postalarını görüntüleyebilir.
     And Admin gecerli username olarak "<username>" girer
     And Admin geçerli password olarak "<password>" girer
