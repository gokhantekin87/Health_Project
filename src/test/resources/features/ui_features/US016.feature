...
# ya yeni odanin datalarini degistirmeli yada ayni datali odayi silmeli
  Scenario: US016 TC002 Admin yeni oda olusturabilir
    ...
    Then yeni odanin bilgilerinin "5900001" "DAYCARE" "10" "team59 otomasyon testi" oldugunu dogrular
    #FAILED STEP
    Then created date "02/09/22" oldugunu dogrular
    And sayfayi kapatir
