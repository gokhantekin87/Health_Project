...
public class US017_DBStepDefs {
    ...
    public void kullaniciLiTestOgesininBilgileriniTablosundanAlir(int actualId, String idColumn, String column, String table) throws SQLException {
...
// created_date=2022-08-30 14:25:56.428112, last_modified_by=admin59, created_by=admin59}]
        ...
        System.out.println("ID si 250218 olan Test Item in Price degeri :  "+DBUtils.getResultset().getObject("price"));
        System.out.println("ID si 250218 olan Test Item Map"+DBUtils.getQueryResultMap(query));
       // System.out.println(DBUtils.getQueryResultList(query));
/*
59.00
[{price=59.00, default_val_min=0, name=test item no:03, description=test item for api/db test validation, default_val_max=100, last_modified_date=2022-08-30 14:25:56.428112, id=250218, created_date=2022-08-30 14:25:56.428112, last_modified_by=admin59, created_by=admin59}]
[[250218, test item no:03, test item for api/db test validation, 59.00, 0, 100, 2022-08-30 14:25:56.428112, admin59, admin59, 2022-08-30 14:25:56.428112]]
 ...
 */
    ...
    @And("sout")
    public void sout() throws SQLException {
